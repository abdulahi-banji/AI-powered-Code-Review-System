        ...
        <footer className="mt-12 pt-8 border-t border-white/10 space-y-3 text-neutral-500 text-sm">
          ...
          <div className="pt-4 flex items-center gap-2">
            ...
            >
              ...
              <svg className="w-5 h-5 relative group-hover:scale-110 group-hover:-rotate-12 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="relative">View Source Code on GitHub</span>
            </a>
          </div>
        </footer>
      </div>
